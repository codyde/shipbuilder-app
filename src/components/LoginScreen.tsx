                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-center space-x-4">
                      <div className={`flex items-center space-x-2 transition-opacity ${authProvider === 'google' ? 'opacity-100' : 'opacity-50'}`}>
                      ...
                      <div className={`flex items-center space-x-2 transition-opacity ${authProvider === 'sentry' ? 'opacity-100' : 'opacity-50'}`}>
                        <img src={sentryLogoWhite} alt="Sentry" className="w-5 h-5" />
                    ...
                    >
                      {isRedirecting ? (
                        ...
                        <>
                          <img src={sentryLogoDark} alt="Sentry" className="w-5 h-5 mr-3" />
